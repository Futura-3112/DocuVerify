        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requirements_AgeCategories_AgeCategoryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requirements_Processes_ProcessId",
                        column: x => x.ProcessId,
                        principalTable: "Processes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requirements_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requirements_AgeCategoryId",
                table: "Requirements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requirements_ProcessId_AgeCategoryId_StateId_DocumentId",
                table: "Requirements",
                columns: new[] { "ProcessId", "AgeCategoryId", "StateId", "DocumentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Requirements_StateId",
                table: "Requirements",
                column: "StateId");
